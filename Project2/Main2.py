...
class Lexer():
    def __init__(self):
        self.lexer = [
            ...
            ('NUM', r'\d+'), ('ENDL', r'\n'), ('KEYWORD_INT', r'int'), ('KEYWORD_WHILE', r'while'),('SPACE', r'\s'),
            ('KEYWORD_IF', r'if'), ('KEYWORD_RETURN', r'return'), ('KEYWORD_ELSE', r'else'), ('KEYWORD_void', r'void'),('KEYWORD_float',r'float'),
